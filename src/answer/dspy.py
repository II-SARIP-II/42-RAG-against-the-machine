...
class SingleSentenceAnswer(dspy.Signature):
    """OONLY Answer the question using a single, short, and direct sentence based ONLY on the provided context. 
    ...
    answer = dspy.OutputField(desc="A single direct sentence answering the question, or 'Information missing.' if not found.")
